...
class EncoderDIPP(nj.Module):
  # TODO observation shapes:
  #  {
  #     'ego': Space(float32, shape=(1, 20, 7), low=-1.0, high=1.0),          SHAPE=(batch_size, history, ego_features)
  #     'global_route': Space(float32, shape=(50, 3), low=-1.0, high=1.0),    SHAPE=(autopilot_way_points?, center_lane_features[i.e. x,y,yaw])
  #     'map': Space(float32, shape=(1, 20, 50, 10), low=-1.0, high=1.0),     SHAPE=(batch_size, closest_lanes, way_points, features)
  #     'neighbors': Space(float32, shape=(1, 10, 20, 7), low=-1.0, high=1.0) SHAPE=(batch_size, closest_neighbours, history, features)
  #  }
